...
export type CtaVariant = "primary" | "secondary" | "engage";

// primary/secondary: extracted from the live frigade.com scrape.
// engage: per-product gradient — light/base/ring computed from --color-engage
// in the marketing site (kept in sync with marketing-ai-experiment cta-button).
export const ctaVariantStyles: Record<CtaVariant, string> = {
  ...
  engage:
    "rounded-lg text-white bg-[linear-gradient(rgb(80,96,118)_0%,rgb(64,78,97)_100%)] shadow-[inset_0_1px_0.4px_0_rgba(255,255,255,0.18),inset_0_-3px_2px_0_rgba(0,0,0,0.28),0_1px_1px_0_rgba(0,0,0,0.14),0_2px_4px_0_rgba(20,30,50,0.18),1px_4px_10px_0_rgba(64,78,97,0.22),0_0_0_1px_rgb(48,60,76)]",
};
